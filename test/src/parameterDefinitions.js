...
let MyClass = AutoClass('', function () {});
let legalTypesCount = 0;
let legalTypes = [Number, String, Function, Object, RegExp, Array, Error, TypeError, MyClass];
...
assert.strictEqual(legalTypesCount, 36, 'tested legal types count');
